...
// Add document
router.post('/courses/:id/document', AuthMiddleware, courseController.createCourseDocument)
...
// Add text
router.post('/courses/:id/text', AuthMiddleware, courseController.createCourseText)
...
// Add test
router.post('/courses/:id/test', AuthMiddleware, courseController.createCourseTest)
...
// Add quiz
router.post('/courses/:id/quiz', AuthMiddleware, courseController.createCourseQuiz)
